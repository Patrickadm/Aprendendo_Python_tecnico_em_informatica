...
#CADASTRO DE FORNECEDORES
        ...
        transp_window.close() 
            ...
            consulta_layout =[
                [sg.Button("Consultar_cliente")],
                #[sg.InputText(key="clientes")],            
                [sg.Button("Consultar_Fornecedor")],
                #[sg.InputText(key="Consultar_Fornecedor")],
                [sg.Button("Consultar_Transpotadora")],
                #[sg.InputText(key="Consultar_Transpotadora")] 
                ]   

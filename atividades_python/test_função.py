...
conn = banco.connect("C:/Users/Senac/Desktop/test_python/clientes.db")
c = conn.cursor()
...
#CADASTRO DE FORNECEDORES
    ...
    if event == "Consulta Clientes":
        ...
        # FUNÇÂO COM QUERY DE MANIPULAÇÂo NO BANCO DE DADOS
        def edit_record(new_product, new_value, old_product):
            c.execute("UPDATE clientes SET nome=?, cpf=?, endereco=?, telefone=?, cidade=?, estado=? WHERE clientes=?",(new_product, new_value, old_product))
            conn.commit()

        def delete_record(product_to_delect):
            c.execute("DELETE FROM clientes WHERE clientes=?",(product_to_delect))
            conn.commit()
    ...
    # AQUI ENTRAMOS NO MENU DE CONSULTA DAS TRANSPORTADORAS CADASTRADAS        
        ...
        #loop eventos
            ...
            while True:
                ...
                if registro:
                    with open("C:/Users/Senac/Desktop/test_python/Relatório_Fornecedores.html","w") as f:
        ...
        #loop eventos
            ...
            while True:
                ...
                if registro:
                    with open("C:/Users/Senac/Desktop/test_python/Relatório_transportadoras.html","w") as f:
                        f.write("<html><head></head><body>")
                        f.write(f"<h1>Relatório<h1><table border='1'><tr><th>Nome</th><th>Cnpj</th><th>Endereço</th><th>Telefone</th><th>Cidade</th><th>Estado</th></tr>")
   ...
   # RELATÓRIO DE CLIENTES         
        ...
        #loop eventos
            ...
            while True:
                ...
                if registro:
                        with open("C:/Users/Senac/Desktop/test_python/Relatório_Clientes.html","w") as f:
                            f.write("<html><head></head><body>")
